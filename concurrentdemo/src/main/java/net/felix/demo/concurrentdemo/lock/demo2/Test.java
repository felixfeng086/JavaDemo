 ...
 * 比如：如果A、B 2个线程去竞争锁，A线程得到了锁，B线程等待，但是A线程这个时候实在有太多事情要处理，
 ...
 */
public class Test {
    //是用ReentrantLock，还是用synchronised
    public static boolean useSynchronised = false;
...
class Reader extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out.println("我暂时不读取buffer了");
        }
        System.out.println("读取Buffer结束");
    }
}